...
//        metadataManager = new RocksDBMetadataManager();
...
//
//            RocksDBMetadataManager newManager = new RocksDBMetadataManager();
...
//        } catch (RocksDBMetadataManager.MetadataException e) {
...
//        assertThrows(RocksDBMetadataManager.MetadataException.class, () -> metadataManager.load("nonexistent.ser"));
//    }
//
//    @Test
